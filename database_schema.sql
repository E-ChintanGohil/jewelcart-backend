...
-- Create ENUM types as VARCHAR with constraints
...
(UUID(), 'admin@jewelcart.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Admin', 'User', 'ADMIN');

INSERT INTO materials (id, name, type) VALUES
(UUID(), 'Gold', 'GOLD'),
(UUID(), 'Silver', 'SILVER');
...
INSERT INTO karats (id, material_id, value, purity, price_per_gram) VALUES
(UUID(), @gold_id, '24K', 99.9, 5500),
(UUID(), @gold_id, '22K', 91.7, 5043),
(UUID(), @gold_id, '18K', 75.0, 4125),
(UUID(), @gold_id, '14K', 58.3, 3206),
(UUID(), @silver_id, '925 Sterling', 92.5, 74),
(UUID(), @silver_id, '999 Fine', 99.9, 80);

INSERT INTO categories (id, name, description, status) VALUES
(UUID(), 'Rings', 'Engagement rings, wedding bands, and fashion rings', 'ACTIVE'),
(UUID(), 'Necklaces', 'Beautiful necklaces for every occasion', 'ACTIVE'),
(UUID(), 'Earrings', 'Elegant earrings to complement any look', 'ACTIVE'),
(UUID(), 'Bracelets', 'Stylish bracelets and bangles', 'ACTIVE');
